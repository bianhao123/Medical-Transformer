...
ori_name = filename;
filename = strcat('E:\download\MoNuSegTestData\', filename)
...
imwrite(binary_mask, strcat('E:\download\MoNuSegTrainingData\Label2\', ori_name,'_binary_mask.png'))
% imwrite(color_mask, strcat('E:\download\MoNuSegTrainingData\data', '_color_mask.png'))
imwrite(color_mask, strcat('E:\download\MoNuSegTrainingData\Label2\', ori_name,'_color_mask.png'))
