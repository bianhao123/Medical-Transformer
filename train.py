...
train_dataset = ImageToImage2D(args.train_dataset, tf_val, phase='train') #TODO  Dataset 没用用tf_tran
val_dataset = ImageToImage2D(args.train_dataset, tf_val, phase='val')
